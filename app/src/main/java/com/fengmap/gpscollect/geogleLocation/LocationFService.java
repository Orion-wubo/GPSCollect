...
public class LocationFService extends Service implements GeoLocationUtils.LocationCallBack {
    ...
    private static final String TAG = LocationFService.class.getSimpleName();
    ...
    public void requestLocationUpdates() {
        ...
        startService(new Intent(getApplicationContext(), LocationFService.class));
        try {
    ...
    public class LocalBinder extends Binder {
        LocationFService getService() {
            return LocationFService.this;
        }
    }
